			...
			<div id="wp-<?php echo $id; ?>-editor-tools" class="wp-editor-tools hide-if-no-js">
				...
				<?php if( user_can_richedit() && $show_tabs ): ?>
					<div class="wp-editor-tabs">
						<a id="<?php echo $id; ?>-html" class="wp-switch-editor switch-html" data-wp-editor-id="<?php echo $id; ?>"><?php echo _x( 'Text', 'Name for the Text editor tab (formerly HTML)' ); ?></a>
						<a id="<?php echo $id; ?>-tmce" class="wp-switch-editor switch-tmce" data-wp-editor-id="<?php echo $id; ?>"><?php echo __('Visual'); ?></a>
					</div>
				<?php endif; ?>
			</div>
