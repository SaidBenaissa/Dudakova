					...
					<?php foreach ( $services as $service ) {
						...
						if ( $state === 'inactive' ) {
							...
							<li>
								...
								<p>
									<button type="submit" class="js-activate-service-id <?php echo $service_activation_button_class; ?>"
									...
									?>
										&nbsp;<a href="<?php echo $service->doc_url; ?>" target="_blank"><?php echo __('Documentation', 'wpml-translation-management'); ?></a>
									<?php
									}
									?>
								</p>
